...
?><?php 
 ...
 $Batch=$_POST['batch'];
  ...
  else
  {
 	...
 	$signup=$_POST['signup'];
	if($signup==0){
	$query="INSERT INTO tbl_alumni2069(name,address,batch,internship,company,gmail,fb) VALUES('$Name','$Address','$Batch','$Internship','$Company','$Gmail','$FB')";
...
<div class="panel panel-primary" style="width:450px; margin:auto;">
	<div class="panel-heading">
		<h3 class="panel-title " style="margin-top:3px;margin-bottom:3px;">2069 Entry</h3>
	</div>
