...
$query2=mysql_query("DELETE FROM tbl_products, tbl_productimage USING tbl_products INNER JOIN tbl_productimage ON tbl_productimage.dresscode_id=tbl_products.dresscode_id WHERE tbl_products.color_id='$id'");
$query=mysql_query("Delete from tbl_productcolor where color_id='$id'");
if(mysql_error()){
        echo mysql_error();
