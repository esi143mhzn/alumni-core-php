...
$query1="UPDATE tbl_admin SET fullname='$fullname' where admin_id='$id'";
$result=mysql_query($query1);
}
?>
<?php 
if(isset($_POST['submit']) && $_POST['submit']=="adminname"){
$id=$_GET['id'];
$adminname=$_POST['new_adminname'];
$query2="UPDATE tbl_admin SET username='$adminname' where admin_id='$id'";
...
$query3="UPDATE tbl_admin SET password='$password' where admin_id='$id'";
...
?>
	...
	<?php
						if(!isset($_SESSION['submit'])){
							...
							$query=mysql_query("select * from tbl_admin where admin_id='$id'");
							}
...
?>
		...
		<th class="new_fullname">
         <form method="post" action="myaccount.php?id=<?=$datas['admin_id'];?>">
		...
		<th>adminname</th>
		<th>:</th>
		<th class="old_adminname"><?= $datas['username']; ?></th>
		<th class="new_adminname">
         <form method="post" action="myaccount.php?id=<?= $datas['admin_id'];?>">
		 <input type="text" name="new_adminname"/>
		 
          <input type="submit" name="submit" value="adminname"/>
	
        </th>
		<th>
		<a href="#" class="edit_adminname"><i class="fa fa-pencil"></i></a>
		</th>
		</tr>
		<tr>
		<th>Password</th>
