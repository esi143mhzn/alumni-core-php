...
<div class="panel panel-primary" style="width:900px; margin:auto;">
	<div class="panel-heading">
		<h3 class="panel-title " style="margin-top:3px;margin-bottom:3px;">List Admin</h3>
	</div>
		...
		<table class="table table-striped table-hover ">
			...
			?>
    			<tr>
					...
					<td><a href="../Delete/admin_delete.php?id=<?php echo $datas['admin_id']; ?>" onclick="return confirm('do you really want to delete?');">
